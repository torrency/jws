...
public class JwsServiceTest {
  ...
  public void decode() {
    ...
    Assertions.assertEquals("authentication", get.getBody().getSubject());
  }
  ...
  public void getFromHeader() {
    ...
    Assertions.assertEquals("authentication", get.get().getBody().getSubject());
  }
  ...
  public void getUserId() {
    ...
    Assertions.assertTrue(get.isPresent());
    Assertions.assertEquals(1, get.get());
  }
}
